...
import shawtNewDesignImage from './shawt-new-design.png'
...
<Image src={shawtNewDesignImage} alt="" />
...
- We added a tutorial. It is displayed automatically at the first visit of a new user (although it can be skipped), and is always available in the menu
