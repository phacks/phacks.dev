...
import reactAdminDemoImage from './react-admin-demo.png'
import wptAuditNetlifyImage from './wpt-audit-netlify.png'
import wptMinimumTestDurationImage from './wpt-minimum-test-duration.png'
import wptSecurityImage from './wpt-security.png'
...
<Image src={wptAuditNetlifyImage} alt="Auditing my dashboard page on Netlify fails" />
...
<Image src={reactAdminDemoImage} alt="The authentication screen of React Admin" />
...
<video controls width="400">
    <source src='/videos/wpt-login-successful.mp4'
            type="video/mp4" />
...
<Image src={wptSecurityImage} alt="WebPageTest security controls" />
...
<Image src={wptMinimumTestDurationImage} alt="WebPageTest minimum test duration" />
