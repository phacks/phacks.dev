...
import shawt1Image from './shawt_1.png'
...
We used [Sketch](https://bohemiancoding.com/sketch/) (Mac only) to design the website, which is a cheap and more intuitive alternative to Photoshop. We advise you to have a look at it if you are interested in webdesign :)

We also picked our color set from [flatuicolors.com](https://www.flatuicolors.com/), a precious resource!
...
We use [Pubnub](https://www.pubnub.com), a message API, to handle the chat part of our app.
