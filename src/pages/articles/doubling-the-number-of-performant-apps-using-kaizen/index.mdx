...
import simplifiedValueFlowImage from './simplified-value-flow.png'
import uberImage from './uber.png'
import valueFlowImage from './value-flow.png'
import valueFlowOnProjectsImage from './value-flow-on-projects.png'
...
<Image src={heroImage} alt="A picture of two persons pair-programming" />
...
<Image src={uberImage} alt="Two screenshots of the Uber mobile app" />
...
<Image src={simplifiedValueFlowImage} alt="The first version of the Performance Value Flow" />
...
<Image src={valueFlowImage} alt="The second version of the Performance Value Flow" />
...
<Image src={valueFlowOnProjectsImage} alt="The Performance Value Flow applied to customers’ projects" />
